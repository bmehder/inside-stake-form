...
<form on:submit|preventDefault={handleSubmit}>
  ...
  <div class="checkbox">
    <input type="checkbox" name="isFee" required /><label
      ...
      to my bank not to exceed $30 total per transfer (up to $10 for ACH and $30
      for Wire transfers).</label
    >
  </div>
  <div class="checkbox">
  ...
  <div>
    <label for="authorize">
      ...
      confidentially to enable payments of distributions to my account. No other
      actions will be taken with this information.
      <input
        class="authorize"
        type="text"
        name="authorize"
